...
begin
    if (Key = #27) and (Screen.Cursor = crNone) then GUINav.ChangeNaviMode;
end;
...
begin
    ...
    begin
      ...
      if d >= 86400000 then      //changed to msecs
        Label14.Caption := '+d ' + FormatDateTime('h:nn:ss.zzz', d / 86400000)
      else
        Label14.Caption := FormatDateTime('h:nn:ss.zzz', d / 86400000);
...
procedure TAnimationForm.Shape1MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TAnimationForm.Shape1MouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
var MPos: TPoint;
    cn: Integer;
begin
