...
{Threading}
  ...
  TCaldDEfunction = function (It3Dex: TPIteration3Dext; mctp: Pointer ): Double; {PMCTparameter}
...
{MandelBulb Parameter Formula Headers and Addons}
...
// -> M3PCalcThread  witness for navicakewalk
